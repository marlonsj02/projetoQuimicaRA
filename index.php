...
$buscar_loginadm = "SELECT * FROM loginadm";
$query_loginadm = mysqli_query($connex, $buscar_loginadm);
                    ...
                    <div class="footer-link d-flex mt-50 justify-content-md-between">
                        <div class="link-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                            ...
                            <ul class="link">
                                ...
                                <li><button data-toggle="modal" data-target="#modalADM" class="btn btn-sm">ADM</button></li>
                            </ul>
                        </div>
                        <!-- footer wrapper -->
...
-->
    ...
    <!-- MODAL PARA EDIÇÃO DE DISCIPLINAS E NOTAS  -->
    <div class="modal" id="modalADM">
        <div class="modal-dialog">
            <div class="modal-content">

                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Login de Administrador
                    </h4>
                </div>

                <!-- Modal body -->
                <div class="modal-body">
                    <form action="back-end/logindireciona.php" method="post">
                        <div class="form-group">
                            <input type="text" class="form-control" name="senhaADM" id="senhaADM" placeholder="Digite sua senha de administrador: ">
                        </div>
